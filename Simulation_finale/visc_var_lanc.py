...
regimes = {
    "MHD": {"N": 25, "T_max": 50, "i": 4, "CFL": 0.1, "delta": 0.05, 
            "Umoyen": 1, "Bmoyen": 1, "di": 0, "nu": 0, "eta": 0, 
            "eps": 1, "M": 30, "constante": 1e-17, "visc_var": False},
...
regimes = {
    ...
    "MHD": {"N": 25, "T_max": 300, "i": 4, "CFL": 0.1, "delta": 0.05, 
            "Umoyen": 1, "Bmoyen": 1, "di": 0, "nu": 1e-12, "eta": 1e-12, 
            "eps": 1, "M": 30, "constante": 1e-17, "visc_var": True},
    ...
    "EMHD": {"N": 50, "T_max": 1000, "i": 8, "CFL": 0.4, "delta": 0.05, 
            "Umoyen": 0, "Bmoyen": 1, "di": 0.3, "nu": 1e-10, "eta": 1e-10, 
            "eps": 2, "M": 30, "constante": 1e-15, "visc_var": True},
    ...
    "HMHD_b": {"N": 48, "T_max": 300, "i": 2, "CFL": 0.4, "delta": 0.05, 
             "Umoyen": 1, "Bmoyen": 1, "di": 30, "nu": 1e-9, "eta": 1e-9, 
             "eps": 2, "M": 30, "constante": 1e-13, "visc_var": True},
    
    "HD": {"N": 25, "T_max": 300, "i": 2, "CFL": 0.05, "delta": 0.05, 
            "Umoyen": 1, "Bmoyen": 0, "di": 0, "nu": 1e-13, "eta": 1e-13, 
            "eps": 1, "M": 30, "constante": 1e-17, "visc_var": True},
