...
regimes = {
    "HMHD_s": {"N": 25, "T_max": 300, "i": 4, "CFL": 0.4, "delta": 0.05, "Umoyen": 1, 
        "Bmoyen": 1, "di": 0.3, "nu": 1e-12, "eta": 1e-12,
        "eps": 1, "M": 30, "constante": 1e-16, "d6": 0.1, "visc_var": True},
}

# "d6" = intensité du non local m = 2,  d6 = 0 pourle modele d'avant (local)

"""
regimes = {
    "HD": {"N": 25, "T_max": 300, "i": 2, "CFL": 0.05, "delta": 0.05, "Umoyen": 1, 
        "Bmoyen": 0, "di": 0, "nu": 1e-13, "eta": 1e-13,
        "eps": 1, "M": 30, "constante": 1e-18, "d6": 0.0, "visc_var": True},

    "MHD": {"N": 25, "T_max": 400, "i": 3, "CFL": 0.1, "mur": 0.05, "Umoyen": 1, "Bmoyen": 1, "di": 0, "nu": 1e-12, "eta": 1e-12, "d6": 0.0},
    "EMHD": {"N": 23, "T_max": 400, "i": 5, "CFL": 0.4, "delta": 0.05, "Umoyen": 0, "Bmoyen": 1, "di": 0.3, "nu": 1e-13, "eta": 1e-13, "eps": 1, "M": 30, "constante": 1e-17, "d6": 0.0},
    "HMHD_s": {"N": 25, "T_max": 300, "i": 4, "CFL": 0.4, "delta": 0.05, "Umoyen": 1, "Bmoyen": 1, "di": 0.3, "nu": 1e-13, "eta": 1e-13, "eps": 1, "M": 30, "d6": 0.0},
    "HMHD_b": {"N": 27, "T_max": 100, "i": 3, "CFL": 0.4, "mur": 0.05, "Umoyen": 1, "Bmoyen": 1, "di": 30, "nu": 1e-9, "eta": 1e-9, "d6": 0.0}
}
"""

couleur = {"HD": "b", "MHD": "y", "EMHD": "r", "HMHD_s": "g", "HMHD_b": "p"}
...
for cas, para in regimes.items():
    ...
    parametre = [
        ...
        para["constante"],
        para["d6"], # indice 15 : intensité du secteur non local m = 2
        para["visc_var"]
        ]
