...
regimes = { "HD": {"N": 200, "T_max": 800, "i": 2, "CFL": 0.05, "mur": 0.05, "Umoyen": 1, "Bmoyen": 0, "di": 0, "nu": 1e-13, "eta": 1e-13, "eps": 8} }

"""
regimes = {
    "HD": {"N": 50, "T_max": 300, "i": 2, "CFL": 0.05, "mur": 0.05, "Umoyen": 1, "Bmoyen": 0, "di": 0, "nu": 1e-13, "eta": 1e-13, "eps" : 2},
...
for cas, para in regimes.items():
    parametre = [para["N"], para["T_max"], time_moy, para["Umoyen"], para["Bmoyen"], para["di"], para["nu"], para["eta"], para["i"], para["CFL"], f"{cas}" , para["eps"]]
     #[nb de couch  print(parametre[11])es, temps max, k, % de moyennage, U départ, B départ, di, nu, eta, centre de gaussienne, coefficient CFL]
    print(parametre[11])
