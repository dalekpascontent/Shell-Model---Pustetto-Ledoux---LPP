...
"""
regimes = {
    "HD": {"N": 25, "T_max": 300, "i": 2, "CFL": 0.05, "delta": 0.05, "Umoyen": 1, "Bmoyen": 0, "di": 0, "nu": 1e-13, "eta": 1e-13, "eps": 1, "M": 30},
    ...
    "HMHD_s": {"N": 25, "T_max": 300, "i": 4, "CFL": 0.4, "mur": 0.05, "Umoyen": 1, "Bmoyen": 1, "di": 0.3, "nu": 1e-12, "eta": 1e-12},
...
for cas, para in regimes.items():
    ...
    Eu, Eb, tau_tc, l_E = ff.moyennage_1run(simulations_same)
